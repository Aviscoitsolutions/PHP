...
?>
  ...
  <link rel="stylesheet" href="<?=$template_directory_uri?>/css/style11.css"> 
	<!-- slider -->
	<!-- slider2 -->
	...
	$template_directory_uri;?>/css/easy-responsive-tabs.css"/>
    <script src="<?php echo 
	$template_directory_uri;?>/js/jquery-1.9.1.min.js"></script>
    <script src="<?php echo 
	$template_directory_uri;?>/js/easyResponsiveTabs.js"></script> -->
	<!-- tab code -->

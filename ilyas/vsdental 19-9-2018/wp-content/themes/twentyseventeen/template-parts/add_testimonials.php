<?php 
/*
Template Name:Add Testimonials
*/
get_header();
$home=get_home_url();
?>
...
<div class="row">
<div class="col-md-6">
<a href="<?=$path;?>/all-testimonials/" class="admnbtn">Dashboard</a>
</div>
<div class="col-md-6 text-right">
<a href="<?=$path;?>/add-testimonials/" class="admnbtn">Add Testimonial</a>
</div>
</div>
</div>
<div class="container">
	...
	<div class="temp">
		<h1 class="text-center">Add Testimonials</h1>

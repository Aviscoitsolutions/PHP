...
//$upload=$ppp['baseurl'];
		...
		if( $count > 0)
			...
			//echo "-".$querychpwd="update wp_login set password='$md5cpwd' where user_id='$user_id'"	;
				...
				$queryexe=mysqli_query($con,$querychpwd);


					$allpage1="select * from wp_login";
					$login1=mysqli_query($con,$allpage1);
				 ...
				 //    }
					...
					//echo "Please again ";exit;
				     wp_redirect($home."/change-password/?flag=right");
				    }
			}
		else
			{
					// echo "Please again ";exit;
			wp_redirect($home."/change-password/?flag=wrong");				
			}

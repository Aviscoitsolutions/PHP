...
//on change
	...
	<div class="row awp_bale_offer">
		...
		<div class="">
			<a href="http://awplife.com/account/signup/all-premium-plugins" target="_blank" class="button button-primary button-hero load-customize hide-if-no-customize"><?php _e('BUY NOW', MSP_TXTDM); ?></a>
		</div>
	</div>
	<hr>
	<p class="">

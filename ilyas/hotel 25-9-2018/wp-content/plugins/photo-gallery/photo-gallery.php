...
final class BWG {
  ...
  public function enqueue_block_editor_assets() {
    ...
    //echo $assets = apply_filters('tw_get_block_editor_assets', array());
  ...
  public function global_script() {
    ...
    <script>
      ...
      function bwg_create_loading_block() {
        jQuery('body').append('<div class="loading_div" style="display:block; width: 100%; height: 100%; opacity: 0.6; position: fixed; background-color: #fff; background-image: url('+ bwg_plugin_url +'/images/spinner.gif); background-position: center; background-repeat: no-repeat; background-size: 50px; z-index: 1001000; top: 0; left: 0;"></div>');
      }

		...
		<?php if ( $isDirectBooking ) { ?>
			<div class="mphb-reserve-room-section mphb-hide">
				<p class="mphb-rooms-quantity-wrapper mphb-hide"><?php
					$select = '<select class="mphb-rooms-quantity" id="mphb-rooms-quantity-' . $typeId . '" name="mphb_rooms_details[' . $typeId . ']">';
				...
				<p class="mphb-rooms-quantity-wrapper mphb-hide">
					<?php printf( __( '%s is available for selected dates.', 'motopress-hotel-booking' ), $roomType->getTitle() ); ?>
				</p>

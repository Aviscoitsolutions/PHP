                    ...
                    body: [
						...
						
						{
							...
							values : [
								...
								{ value: 'Japanese-Japan', text: 'Japanese-Japan', classes:"stockdio_class_c s_h_c s_q_b s_m_o" },
								{ value: 'Korean-Korea', text: 'Korean-Korea', classes:"stockdio_class_c s_h_c s_q_b s_m_o" },
								{ value: 'Russian-Russia', text: 'Russian-Russia', classes:"stockdio_class_c s_h_c s_q_b s_m_o" },
								{ value: 'Polish-Poland', text: 'Polish-Poland', classes:"stockdio_class_c s_h_c s_q_b s_m_o" }	
							],
							onclick:function(){
